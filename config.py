...
YTPROXY_URL = getenv("YTPROXY_URL", 'https://api.thequickearn.xyz') ## E.G https://yt.okflix.
YT_API_KEY = "NxGBNexGenBots0e3463"
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/ifgovtjoftibcdjpvd8nfiokbfobffob0vrb8bd/apimusic",
)
